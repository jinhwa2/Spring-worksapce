...
public class IndexController {
	...
	@GetMapping("cafe/cafe-index") //주소창에서 back과 front 만나는 주소(만남의 장소 위치)
	public String cafeMainMethod() {
		log.info("cafe index 메인으로 이동");
		return "cafe_index";//html파일 위칭
	}
	...
	@GetMapping("blog/bolg-board")
	public String blogBoardMethod() {
		log.info("bolg board 게시판으로 이동");
		return "blog/blog-board";
	}
	
	//cafe_board로 이동하는 getMapping만들기
